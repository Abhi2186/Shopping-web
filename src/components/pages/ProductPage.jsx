  ...
  return (
    <div>
      ...
      <div className='flex justify-center'>
        ...
        <div className='flex-[1.3] flex justify-items-start items-start flex-col mt-10'>
            <h1 className='title text-[40px]'> Black Hoodie Original</h1>
            <p className='pr-[4rem] text-justify mt-4'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eum asperiores ut nihil libero ipsum magni? Nam in reprehenderit veritatis consequatur. Placeat distinctio id, amet aliquam minus earum corporis ipsam sequi?</p>
